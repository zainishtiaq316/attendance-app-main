...
class CheckInScreen extends StatefulWidget {
  ...
  @override
  State<CheckInScreen> createState() => _markattState();
}

class _markattState extends State<CheckInScreen> {
  ...
  if (isSignedInFirebase) {
    ...
    FirebaseFirestore.instance
      ...
      if (documentSnapshot.exists) {
        loggedInUser = UserModel.fromMap(documentSnapshot.data() as Map<String, dynamic>);
        setState(() {
